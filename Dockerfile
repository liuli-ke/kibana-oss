...
RUN set -e ; \
    ...
    case "$(arch)" in \
        aarch64) \
            ARCH_INFO="arm64" ; \
            SHA256SUM_INFO="45b1bbf56cc03edda81e4220535a025bfe3ed6e93562222b9be4471005b3eeb3" ; \
            ;; \
        x86_64) \
            ARCH_INFO="amd64" ; \
            SHA256SUM_INFO="37f2c1f0372a45554f1b89924fbb134fc24c3756efaedf11e07f599494e0eff9" ; \
            ;; \
        *) echo >&2 "Unsupported architecture $(arch)" ; exit 1 ;; \
    esac ; \
  curl -L -o /usr/local/bin/dumb-init https://github.com/Yelp/dumb-init/releases/download/v1.2.2/dumb-init_1.2.2_${ARCH_INFO} ; \
  echo "${SHA256SUM_INFO}  /usr/local/bin/dumb-init" | sha256sum -c - ; \
...
LABEL org.label-schema.build-date="2021-01-13T02:23:45.910Z" \
